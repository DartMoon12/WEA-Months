...
const Aboutus = () => {
  return (
    ...
    <h2 >Něco Málo o Nás</h2>
      <div className="karta">
      <p>Vítejte na našem webu! Jsme firma TuCode, váš průvodce digitálním světem vzdělávání.
          ...
          Připojte se k nám a začněte svou cestu k úspěchu ještě dnes!</p>
      
      <Image src="/images/kys.png" alt="logo" layout = "responsive" width={400} height={300} />
      </div>
      </div>
    </>
  )
